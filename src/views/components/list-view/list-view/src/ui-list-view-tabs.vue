<template>
  ...
  >
    ...
    >
      ...
      <ui-tab-item prefix="<span style='font-size:20px' class='icon-ic_lines'></span>">
        <ui-list-view-item
          :selected="false"
          :hovered="false"
          :disabled="false"
...
export default class UiListViewTabsComponent extends Vue {
  ...
  @Prop({ default: EnumTypeList[1], type: String })
  typeView: EnumTypeList;
