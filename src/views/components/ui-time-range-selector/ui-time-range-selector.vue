<template>
  <div class="ui-time-range-selector" v-if="!linkedDatePickerName">
    <ui-hour-selector
...
import UiMinuteSelector from "@views/components/ui-time-range-selector/ui-minute-selector.vue";
import UiHourSelector from "@views/components/ui-time-range-selector/ui-hour-selector.vue";
@Options<UiTimeRangeSelector>({
  watch: {
    maximumView(value) {
  ...
  components: { UiHourSelector, UiMinuteSelector },
})
export default class UiTimeRangeSelector extends Vue {
