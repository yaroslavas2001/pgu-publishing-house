<template>
  <div class="one-date-selector" v-if="!linkedDatePickerName">
    <ui-one-day-selector
...
export default class UiOneDateSelector extends Vue {
